...
#SBATCH --mem=96G
#SBATCH --gres=gpu:pro_6000:2
#SBATCH -o /home/yoonjoo_chae/AIUC/logs/slurm/rnncell_strict_online_hours_2gpu_g2_%j.out
...
OUTPUT_DIR="AIUC/outputs/rnncell_strict_online_hours_w${ONLINE_HOURS_WEIGHT}_2gpu_g2_${JOB_ID}"
