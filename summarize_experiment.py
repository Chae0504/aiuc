...
def main():
    ...
    job_id = job_id.removeprefix(
        "rnncell_strict_allocation_lookahead_repair_"
    )
    job_id = job_id.removeprefix("rnncell_strict_allocation_repair_")
    job_id = job_id.removeprefix("rnncell_strict_allocation_")
